                ...
                <div className='box boxPalestrante'>  
                    ...
                    <div className='picTxt'>
                        ...
                        <p>
                            ...
                            da UERJ. É líder do grupo de pesquisa Cultura Urbanismo Resistência Arquitetura - CURA, certificado pelo 
                            CNPQ/UERJ, e desenvolve pesquisas sobre arquiteturas autóctones, a função social do arquiteto e os 
                            atravessamentos contemporâneos entre arte e arquitetura. No campo das artes visuais, atua com expografia 
                            e desenvolve investigações sobre exposições de arte contemporânea e interferências urbanas.
                        </p>
                ...
                <div className='box boxPalestrante'>  
                    ...
                    <div className='picTxt'>
                        ...
                        <p>
                            ...
                            Na prefeitura do Rio de Janeiro, ocupou os cargos de subprefeito do Centro, entre 1993 e 2001, e 
                            de Secretário de Urbanismo, entre 2006 e 2008, entre outros. Foi um dos responsáveis pela concepção do 
                            Corredor Cultural, projeto de preservação e revitalização do Centro do Rio de Janeiro.
                        </p>
                ...
                <div className='box boxPalestrante'>  
                    ...
                    <div className='picTxt'>
                        ...
                        <p>
                            ...
                            processos coparticipativos, diluição de autoria, tempo e circularidade, celebrando a relação entre o homem e a natureza, o racional 
                            e o instintivo, o caos e o rigor, a solidão e a coletividade.
                        </p>
                ...
                <div className='box boxPalestrante'>  
                    ...
                    <div className='picTxt'>
                        ...
                        <p>
                            ...
                            atualmente mapeia a produção de arquitetas negras brasileiras. Pesquisa o racismo estrutural e suas influências no planejamento urbano e na 
                            arquitetura contemporânea produzida em África e sua diáspora. Entre outros, propõe ações que promovem o debate de gênero e raça na Arquitetura 
                            como forma de dar visibilidade à questão. Assina o editorial da Revista Arquitetas Negras vol.1, a primeira publicação feita por arquitetas negras no Brasil. 
                            Primeira vice-presidente do Instituto de Arquitetos do Brasil no departamento de São Paulo (IABsp). 
                        </p>

                    </div>

                </div><div className='separa blue'> 
                 <p> * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * </p>
                </div>
                ...
                <div className='box boxPalestrante'>  
                    ...
                    <div className='picTxt'>
                        ...
                        <p>
                            ...
                            venceu o Prêmio de Teses da Associação Nacional de Pós-Graduação e Pesquisa em Planejamento Urbano e Regional, com um trabalho intitulado "Corpo, 
                            discurso e território: Cidade em disputa nas dobras da narrativa de Carolina Maria de Jesus". É também integrante da Coletiva Terra Preta.
                        </p>
                ...
                <div className='box boxPalestrante'>  
                    ...
                    <div className='picTxt'>
                        ...
                        <p>
                            ...
                            as Lonas Culturais, a distribuidora RioFilme, os centros culturais Laurinda Santos Lobo, José Bonifácio, Parque das Ruínas, a coleção Perfis e Cantos do Rio e o Programa 
                            de Apoio e Dança Contemporânea. Em 1999 assumiu a Coordenação Nacional da Mostra do Redescobrimento – Brasil 500 Anos, em São Paulo. Em 2001 foi convidada para retornar ao 
                            Rio na condição de Secretária Estadual de Cultura, cargo que exerceu até assumir a Presidência da Fundação Theatro Municipal do RJ, em 2004.
                        </p>
                ...
                <div className='box boxPalestrante'>  
                    ...
                    <div className='picTxt'>
                        ...
                        <p> 
                            ...
                            Fundação Suíça Pro Helvetia no Brasil. Integrou a equipe de curadoria e pesquisa da Casa França-Brasil durante a gestão de Marcelo Campos. Já escreveu 
                            para Select, Edições Sesc São Paulo, Bazar Arte e Canal Contemporâneo. 
                        </p>
                ...
                <div className='box boxPalestrante'>  
                    ...
                    <div className='picTxt'>
                        ...
                        <p>
                            ...
                            No Museu Bispo do Rosário Arte Contemporânea, instituição da qual passou a fazer parte em 2008, idealizou e coordenou, entre outros projetos, o 
                            I Encontro de Agentes Culturais da Zona Oeste e a primeira edição do Programa Casa B Residência Artística. Ainda no Museu, organizou importantes 
                            exposições nacionais e internacionais e foi curador assistente da mostra “Arthur Bispo do Rosário: a poesia do fio”, realizada no âmbito do Festival Europalia (Bruxelas/BE). 
                            Como profissional independente, produziu, entre outras, a mostra “Narrativas Poéticas - Coleção Santander Brasil” e foi contemplado no Rumos - Itaú Cultural (2018-2019) 
                            com o projeto “Brígida”, de organização da obra audiovisual da artista Brígida Baltar. Atualmente também é assessor de artes visuais do Sesc Nacional.
                        </p>
